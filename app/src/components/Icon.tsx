 ...
 * should not carry a webfont for a couple dozen glyphs, and inline paths
...
const PATHS: Record<IconName, string> = {
  ...
  "eye-off":
    "M3 3l18 18M10.6 10.6a3 3 0 0 0 4.2 4.2M9.4 5.3A9.7 9.7 0 0 1 12 5c6.4 0 10 7 10 7a17 17 0 0 1-3.2 4M6.2 6.6A17 17 0 0 0 2 12s3.6 7 10 7c1.3 0 2.5-.3 3.5-.7",
  ...
  shield: "M12 3l8 3v6c0 4.4-3.2 7.7-8 9-4.8-1.3-8-4.6-8-9V6zM9 12l2 2 4-4",
  globe:
